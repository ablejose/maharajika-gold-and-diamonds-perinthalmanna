...
export const BRAND: BrandConfig = {
  businessName: "Maharajika Gold and Diamonds",
  tagline: "Gold & Diamond Jewellery in Perinthalmanna",
  description:
    "Maharajika Gold and Diamonds is Perinthalmanna's destination for aesthetic gold, diamond and silver jewellery. Located on NH 213 in Perinthalmanna, we serve the town with timeless craftsmanship for every celebration.",
  ...
  address: "NH 213, Near Ramdas Clinic and Nursing Home, KSHB Colony, Perinthalmanna, Kerala 679322",
  city: "Perinthalmanna",
  state: "Kerala",
  pincode: "679322",

  phone: "+919645222916",
  whatsapp: "919645222916",
  email: "",

  mapsLink: "https://share.google/pontEBr9afeRcmgvJ",

  openingHours: "",

  instagram: "https://www.instagram.com/maharajika_gold_and_diamonds/",
  facebook: "https://www.facebook.com/maharajikagold",

  seo: {
    title: "Maharajika Gold and Diamonds | Jewellery in Perinthalmanna",
    description:
      "Maharajika Gold and Diamonds — gold, diamond and silver jewellery in Perinthalmanna, Kerala. Timeless craftsmanship for every celebration.",
    keywords: [
      "Maharajika Gold and Diamonds",
      "Maharajika Gold Perinthalmanna",
      "jewellery Perinthalmanna",
      "gold jewellery Perinthalmanna",
      "diamonds Perinthalmanna",
      "jewellery store Perinthalmanna",
      "jewellery Kerala",
    ],
    canonical: "https://maharajikagold.com",
  ...
  whatsappMessage:
    "Hello Maharajika Gold and Diamonds, I'd like to know more about your jewellery collections.",
};
